...
async def sign_tx(ctx: Context, msg: StellarSignTx, keychain: Keychain) -> StellarSignedTx:
...
async def _timebounds(ctx: Context, w: bytearray, start: int | None, end: int | None) -> None:
