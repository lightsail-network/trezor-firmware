from trezor.enums import StellarAssetType, StellarMemoType
...
def _write_asset_code(w: Writer, asset_type: StellarAssetType, asset_code: str | None) -> None:
...
def _write_asset(w: Writer, asset: StellarAsset) -> None:
    if asset.type == StellarAssetType.NATIVE:
        ...
        return
    if asset.code or asset.issuer is None:
        raise DataError("Stellar: invalid asset")
