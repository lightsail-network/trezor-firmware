...
async def confirm_account_merge_op(
    ctx: Context, op: StellarAccountMergeOp
) -> None:
    await confirm_address(
        ctx,
        "Account Merge",
...
async def confirm_bump_sequence_op(
    ctx: Context, op: StellarBumpSequenceOp
) -> None:
...
async def confirm_change_trust_op(
    ctx: Context, op: StellarChangeTrustOp
) -> None:
...
async def confirm_create_account_op(
    ctx: Context, op: StellarCreateAccountOp
) -> None:
    await confirm_properties(
        ctx,
        "op_create_account",
...
async def confirm_manage_offer_op(
...
async def confirm_path_payment_op(
    ctx: Context, op: StellarPathPaymentOp
) -> None:
